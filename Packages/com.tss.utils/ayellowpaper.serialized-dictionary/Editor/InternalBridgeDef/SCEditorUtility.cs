...
{
    public static class SCEditorUtility
    {
        ...
        public static bool HasDrawerForType(SerializedProperty property, Type type)
        {
            return ScriptAttributeUtility.GetDrawerTypeForPropertyAndType(property, type) != null;
        }

        public static void AddGenericMenuItem(GenericMenu genericMenu, bool isOn, bool isEnabled, GUIContent content, GenericMenu.MenuFunction action)
        {
            if (isEnabled)
        ...
        public static void AddGenericMenuItem(GenericMenu genericMenu, bool isOn, bool isEnabled, GUIContent content, GenericMenu.MenuFunction2 action, object userData)
        {
            if (isEnabled)
        ...
        public static bool TryGetTypeFromProperty(SerializedProperty property, out Type type)
        {
            try
            {
